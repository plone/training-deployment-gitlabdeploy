...
Install playclusterdemo with uv.

```shell
uv add playclusterdemo
```
...
- [Issue tracker](https://gitlab.com/plone-training1/training-deployment-gitlabdeploy/-/issues)
- [Source code](https://gitlab.com/plone-training1/training-deployment-gitlabdeploy)
...
1.  Clone this repository.
    ...
    cd training-deployment-gitlabdeploy/backend
    ```
