...
# training-deployment-gitlabdeploy build configuration file
...
project = "training-deployment-gitlabdeploy"
...
linkcheck_ignore = [
    ...
    r"https://gitlab.com/plone-training1/training-deployment-gitlabdeploy/-/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://gitlab.com/plone-training1/training-deployment-gitlabdeploy",
    ...
    "logo": {
        "text": "training-deployment-gitlabdeploy",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://gitlab.com/plone-training1/training-deployment-gitlabdeploy",
...
# html_context = {
#     "edit_page_url_template": "https://gitlab.com/plone-training1/training-deployment-gitlabdeploy/-/edit/main/docs/",
# }
...
ogp_site_name = "training-deployment-gitlabdeploy Documentation"
ogp_type = "website"
...
htmlhelp_basename = "training-deployment-gitlabdeployDocumentation"
...
latex_documents = [
    (
        "index",
        "training-deployment-gitlabdeployDocumentation.tex",
        "training-deployment-gitlabdeploy Documentation",
        "Fred van Dijk",
        "manual",
    ),
]
...
rinoh_documents = [
    {
        "doc": "index",
        "target": "training-deployment-gitlabdeployDocumentation",
        "title": "training-deployment-gitlabdeploy Documentation",
        "subtitle": "",
        "author": "Fred van Dijk",
    },
]
